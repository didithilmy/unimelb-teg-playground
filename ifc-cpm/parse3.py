...
IfcToCpmConverterBuilder("ifc/rac_advanced_sample_project.ifc").build(origin=(5, 5), close_wall_gap_metre=0.2, min_wall_height_metre=0.5).write("cpm/rac_advanced_sample_project.cpm")
